package meta.modding.week_editor.backup;
...
class BackUpWEEKEDITOR extends meta.states.MusicBeatState
{
...
class FreeplayEditor extends MusicBeatState
{
	...
	var lastWeek:Int = 0;
	public function new(weeky:Int,weekData:WeekFile)
	{
		super();
		lastWeek = weeky;
		_weekFile = weekData;
	...
	override function update(elapsed:Float)
	{
		...
		else
		{
			...
			if (FlxG.keys.justPressed.ESCAPE)
			{
				...
				FlxG.switchState(new meta.modding.week_editor.WeekEditor(lastWeek,_weekFile));
			}
