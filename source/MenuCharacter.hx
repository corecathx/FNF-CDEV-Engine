...
{
	private static var charSettings:Map<String, CharObjSetting> = [
		'bf' => new CharObjSetting(0, -20, 1.0, true),
		'gf' => new CharObjSetting(50, 80, 1.5, true),
		'dad' => new CharObjSetting(-15, 130),
		'spooky' => new CharObjSetting(20, 30),
		'pico' => new CharObjSetting(0, 0, 1.0, true),
		'mom' => new CharObjSetting(-30, 140, 0.85),
		'parents-christmas' => new CharObjSetting(100, 130, 1.8),
		'senpai' => new CharObjSetting(-40, -45, 1.4)
	];
	...
	{
		var lastCharacter:Bool = character == this.character;
		...
		var setting:CharObjSetting = charSettings[character];
		offset.set(setting.x, setting.y);
		setGraphicSize(Std.int(width * setting.scale));
		flipX = setting.flipped != flipped;
	}

	public function playIdle(LastFrame:Bool = false):Void
	{
