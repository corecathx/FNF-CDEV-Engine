...
class CDEV_FlxColor
{
	...
	public static function fromCMYK(Cyan:Float, Magenta:Float, Yellow:Float, Black:Float, Alpha:Float):CDEV_FlxColor
	{
		return new CDEV_FlxColor(FlxColor.fromCMYK(Cyan, Magenta, Yellow, Black, Alpha));
	}

	public static function fromHSB(Hue:Float, Saturation:Float, Brightness:Float, Alpha:Float = 1):CDEV_FlxColor
	{
		return new CDEV_FlxColor(FlxColor.fromHSB(Hue, Saturation, Brightness, Alpha));
	}

	public static function fromHSL(Hue:Float, Saturation:Float, Lightness:Float, Alpha:Float = 1):CDEV_FlxColor
	{
		return new CDEV_FlxColor(FlxColor.fromHSL(Hue, Saturation, Lightness, Alpha));
	}

	public static function fromInt(Value:Int):CDEV_FlxColor
	{
		return new CDEV_FlxColor(Value);
	}

	public static function fromRGB(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255):CDEV_FlxColor
	{
		return new CDEV_FlxColor(FlxColor.fromRGB(Red, Blue, Green, Alpha));
	}

	public static function fromRGBFloat(Red:Float, Green:Float, Blue:Float, Alpha:Float = 1):CDEV_FlxColor
	{
		return new CDEV_FlxColor(FlxColor.fromRGBFloat(Red, Blue, Green, Alpha));
	}

	public static function fromString(str:String):Null<CDEV_FlxColor>
	{
		var color = FlxColor.fromString(str);
		if (color == null)
			return null;
		else
			return new CDEV_FlxColor(color);
	}
